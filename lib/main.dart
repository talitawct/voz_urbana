...
import 'features/settings/presentation/settings_screen.dart'; // Corrigido
import 'features/profile/presentation/profile_screen.dart';   // Corrigido
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // Suas rotas configuradas perfeitamente:
        '/settings': (context) => SettingsScreen(
              onThemeToggle: toggleTheme, // Corrigido para corresponder ao seu widget
